...
public class CuentaFinancieraReporteDTO implements Serializable {
	...
	public CuentaFinancieraReporteDTO(String cuenta, String anioMenos5, String anioMenos4, String anioMenos3,
			String anioMenos2, String anioMenos1) {
		this.cuenta = cuenta;
