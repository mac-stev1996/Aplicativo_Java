 ...
 *
 */
@ManagedBean(name = "cxcRepAnticipoMensualController")
@ViewScoped
public class CxcRepAnticipoMensualController extends ReportCommonController implements Serializable {
	static Logger logger = Logger.getLogger(CxcRepAnticipoMensualController.class);
	/**
	 * 
	 */
	...
	public void cargarLineasNrgocio() {
		try {
			listarLineasNegocio = lineaNegocioService.obtenerLineasAplicaAnticipos(getCompania().getNoCia());
	...
	public String report() {
		if (fechaAnticipo == null) {
			error("Es obligatorio ingresar la fecha");
			return null;
		}
	...
	private void setParameters(Map<String, Object> parameters) {
		...
		parameters.put("MES", FechaUtils.getMes(fechaAnticipo));
		parameters.put("ANIO",FechaUtils.getAno(fechaAnticipo));
